...
class Configuartion:
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        try:
            ...
            add_bedroom_per_key = data_transformation_config_info[DATA_TRANSFORMATION_ADD_BEDROOM_PER_ROOM_KEY]
            ...
            data_transformation_config = DataTransformationConfig(add_bedroom_per_room = add_bedroom_per_key, 
